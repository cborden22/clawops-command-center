...
export default function Documents() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const htmlContent = `
        ...
        <head>
          ...
          <style>
            * {
            ...
            /* Compensation section - Special styling */
            .compensation { 
              margin-bottom: 20px; 
              padding: 15px; 
        ...
        <body>
          <div class="container">
            ...
            <div class="parties">
              <h3 class="parties-title">PARTIES TO THIS AGREEMENT</h3>
      ...
      // Generate PDF with optimized configuration for better page handling
      const opt = {
        margin: [8, 8, 8, 8],
        filename: filename,
