    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative glass-card p-6 lg:p-8 rounded-2xl">
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 mb-4">
              <div className="relative flex-shrink-0">
                <div className="p-3 bg-gradient-to-br from-gold-500 to-gold-600 rounded-xl shadow-lg">
                  <Navigation className="h-6 w-6 lg:h-8 lg:w-8 text-primary-foreground" />
                </div>
                <div className="absolute -inset-1 bg-gradient-to-br from-gold-500 to-gold-600 rounded-xl opacity-20 blur animate-glow" />
              </div>
              <div className="flex-1">
                <h1 className="text-2xl lg:text-4xl font-bold bg-gradient-to-r from-gold-500 to-gold-600 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          {/* Input Section - Takes more space on larger screens */}
          <div className="lg:col-span-7">
            <Card className="glass-card border-white/10 accent-glow h-fit">
              <CardHeader className="pb-4 lg:pb-6">
                <CardTitle className="text-xl lg:text-2xl font-bold flex items-center gap-2">
                  <Route className="h-5 w-5 lg:h-6 lg:w-6 text-gold-500" />
                  Route Configuration
                </CardTitle>
              ...
              <CardContent className="space-y-4 lg:space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
                    {routeStops.map((stop, index) => (
                      <div key={index} className="space-y-3 p-3 lg:p-4 glass-card rounded-xl border border-white/10">
                        <div className="flex gap-3">
                          <div className="flex-1 min-w-0">
                            <Input
                              ...
                              className="bg-white/5 border-white/20 focus:border-gold-500 transition-colors w-full"
                            />
                          </div>
                          <Button
                            variant="outline"
                            ...
                            className="border-red-500/20 hover:bg-red-500/10 hover:border-red-500/40 transition-colors flex-shrink-0"
                          >
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 lg:pt-6">
                  ...
                  <Button 
                    variant="outline" 
                    onClick={clearAll}
                    className="border-white/20 hover:bg-white/5 transition-colors sm:w-auto"
                  >
                    Clear All
                  </Button>
                </div>
