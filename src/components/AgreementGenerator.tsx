      ...
      const htmlContent = `
        ...
        <head>
          ...
          <style>
            ...
            .party-title { font-weight: bold; font-size: 14px; margin-bottom: 8px; text-decoration: underline; }
            .section { margin-bottom: 20px; page-break-inside: avoid; }
            .section-title { font-size: 16px; font-weight: bold; margin-bottom: 10px; }
            .section-content { margin-bottom: 15px; }
            .compensation-box { background-color: #f5f5f5; padding: 15px; margin: 10px 0; border: 1px solid #ddd; text-align: center; font-weight: bold; }
            .responsibilities { display: table; width: 100%; margin: 15px 0; }
            .responsibility-column { display: table-cell; width: 50%; vertical-align: top; padding: 0 10px; }
            .responsibility-title { font-weight: bold; margin-bottom: 8px; text-decoration: underline; }
            ...
            .signature-line { border-bottom: 1px solid #000; width: 200px; height: 30px; margin: 20px auto; }
          </style>
        </head>
        <body>
          <div class="header">
          ...
          <div class="section">
            ...
            <div class="section-content">The Provider agrees to place and operate one or more claw machines (the "Machine(s)") at the Location Owner's place of business. The Location Owner agrees to host the Machine(s) in exchange for compensation as outlined in Section 3.</div>
          </div>
          <div class="section">
            <div class="section-title">2. TERM</div>
            <div class="section-content">This Agreement is valid for <strong>12 months</strong>, beginning on <strong>${formData["Start Date"] instanceof Date ? format(formData["Start Date"], "PPP") : formData["Start Date"] || "[Start Date]"}</strong> and ending on <strong>${formData["End Date"] instanceof Date ? format(formData["End Date"], "PPP") : formData["End Date"] || "[End Date]"}</strong>, unless terminated earlier as outlined in Section 9.</div>
          </div>
          <div class="section">
            <div class="section-title">3. COMPENSATION</div>
            <div class="section-content">The Provider will collect all revenue from the Machine(s) and compensate the Location Owner with:</div>
            <div class="compensation-box">${paymentDetails}</div>
            <div class="section-content">Payments will be made by the <strong>10th of each month</strong> for the prior month's earnings via <strong>${safePaymentMethod || "[Payment Method]"}</strong>.</div>
          </div>
          <div class="section">
          ...
          <div class="section">
            ...
            <div class="section-content">The Location Owner will not be held liable for theft, vandalism, or accidental damage to the Machine(s).</div>
            <div class="section-content"><strong>In the event of incidents, the Location Owner agrees to:</strong>
              <ul>
          ...
          <div class="section">
            ...
            <div class="section-content">The Provider is responsible for carrying comprehensive insurance for equipment and general liability. The Location Owner assumes no liability for injuries or damages related to the Machine(s), except in cases of gross negligence.</div>
          </div>
          <div class="section">
            <div class="section-title">7. MARKETING & SIGNAGE</div>
            <div class="section-content">The Provider may display branding and promotional signage on or immediately near the Machine(s). Any additional signage in other areas of the premises must receive prior written approval from the Location Owner.</div>
          </div>
          <div class="section">
            <div class="section-title">8. RELOCATION OR REMOVAL</div>
            <div class="section-content">The Provider may replace, relocate, or remove the Machine(s) with <strong>${safeNoticePeriod || "[Notice Period]"}</strong> notice to the Location Owner. The Location Owner may request relocation of the machine within the business premises if operationally necessary.</div>
          </div>
          <div class="section">
            <div class="section-title">9. TERMINATION</div>
            <div class="section-content">Either party may terminate this Agreement with <strong>30 days' written notice</strong>. Immediate termination is permitted in the event of material breach that remains uncured after 7 days' written notice.</div>
          </div>
          <div class="section">
            <div class="section-title">10. RENEWAL</div>
            <div class="section-content">If neither party provides written notice of termination at least 30 days before the end date, this Agreement automatically renews for another 12-month term under the same conditions.</div>
          </div>
          <div class="section">
            <div class="section-title">11. ENTIRE AGREEMENT</div>
            <div class="section-content">This document represents the complete agreement between the Parties. Any amendments must be in writing and signed by both Parties. This Agreement supersedes all prior negotiations, understandings, or agreements.</div>
          </div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">Location Agreement Creator</h2>
          <p className="text-sm text-muted-foreground">Create professional claw machine placement agreements</p>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Add locations in the Locations tab to quickly fill in business details.
                  </p>
                </div>
              </div>
            </div>
